...
window.SCHEMES = [
  ...
  baseScheme({ id:"PR011", road_name:"Guthrie Terrace", project_number:"R6083",
    scheme_type:"Carriageway",
    scheme_extent: "Full carriageway — full length of Guthrie Terrace",
    area_m2: 175,
    grid_ref: "340150 730230",
    treatment_type:"HRA 30/14F surf 40/60",
    surface_depth_mm: 40, binder_depth_mm: 0, subbase_depth_mm: 0, total_depth_mm: 40,
    binder_grade: "40/60",
    ...
    treatments: [
      { id:1, zone:"Full carriageway — 40mm HRA surface course", area_m2:175, depth_mm:40, treatment_type:"HRA 30/14F surf 40/60" },
    ],
    zone_a1_description: "Full carriageway — 40mm HRA surface course", zone_a1_area_m2: 175, zone_a1_depth_mm: 40, zone_a1_treatment: "HRA 30/14F surf 40/60",
    ...
    iron_mh: 1, iron_water: 0, iron_gas: 0, iron_bt: 0, iron_gullies: 2,
    kerb_length: 0, lining_req: "No",
    pci_justification: "Surface deterioration and cracking across the full width of Guthrie Terrace carriageway. Existing surface has exceeded its serviceable life and requires full resurfacing to restore ride quality and prevent further structural deterioration. Pre-design sketch R6083 PDS-01 confirms scheme extent of 175m².",
    pci_description: "Carriageway resurfacing of Guthrie Terrace as per pre-design sketch R6083 PDS-01 (Dundee City Council Roads Maintenance Partnership, dated 15/12/2025) and formal resurfacing plan R6083-DCC-ZZ-DR-C-001.\n\n40mm HRA Carriageway Resurfacing — 175m²: plane off existing surface to a depth of 40mm across the full carriageway extent. DCC Engineer present during operations to identify any localised areas requiring deeper excavation. Post-milling: lay 40mm HRA 30/14F (40/60 pen binder) surface course. Pre-coated chippings to be evenly distributed and fully embedded. Material temperatures to be recorded on delivery and prior to laying. Form smooth transition ramps at all tie-in points.\n\nWorks programme: 2 working days (15/06/2026 to 17/06/2026).\n\nIronwork: 1 no. manhole cover to be reset to new surface level. 2 no. gully gratings to be adjusted and tied into new surface levels.\n\nRoad markings: no road marking reinstatement required on completion of surfacing.\n\nAll temporary reinstatements within the scheme extent to be made permanent prior to works commencing.",
    pci_ironwork_summary: "1 no. manhole cover and frame to be reset. 2 no. existing gully gratings to be adjusted to new surface level. Ref: R6083-DCC-ZZ-DR-C-001.",
    pci_lining_summary: "No road marking reinstatement required.",
    pci_occupiers: "Residential properties along full length of Guthrie Terrace to be notified in advance of works. St. Margaret's Church (adjacent to western end of scheme) to be informed — pedestrian access to the church to be maintained at all times during working hours.",
    haz_public: "Works to be carried out under a partial road closure with signed diversion in accordance with the Safety at Street Works and Road Works Code of Practice. Pedestrian access to all residential properties along Guthrie Terrace to be maintained at all times. Pedestrian access to St. Margaret's Church to be maintained throughout the duration of the works. Vehicular access for emergency services to be maintained throughout.",
