...
window.SCHEMES = [
  ...
  baseScheme({ id:'R6012', road_name:'Ashbank Road', scheme_extent:'Logie Avenue to Scott Street', scheme_type:'Carriageway', project_number:'R6012', carriageway_area_m2:423, budget:14805, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'22/02/2027', date_finish:'26/02/2027', ..._KD }),
  ...
  baseScheme({ id:'CW-BALLANTRAE', road_name:'Ballantrae Road', scheme_extent:'Ballantrae Place to Balmerino Road', scheme_type:'Carriageway', carriageway_area_m2:764, budget:26740, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'15/02/2027', date_finish:'19/02/2027', ..._KD }),
  baseScheme({ id:'R6014-A', road_name:'Balmerino Road', scheme_extent:'Balmoral Terrace to Nr 46', scheme_type:'Carriageway', project_number:'R6014', carriageway_area_m2:612, budget:36720, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'15/06/2026', date_finish:'19/06/2026', ..._BC }),
  baseScheme({ id:'R6014-B', road_name:'Balmoral Terrace', scheme_extent:'Whole Road', scheme_type:'Carriageway', project_number:'R6014', carriageway_area_m2:1655, budget:87225, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'15/06/2026', date_finish:'19/06/2026', ..._BC }),
  ...
  baseScheme({ id:'CW-BROOMHILL', road_name:'Broomhill Road', scheme_extent:'Dunsinane Avenue to Carlunie Road', scheme_type:'Carriageway', carriageway_area_m2:500, budget:17500, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'05/01/2027', date_finish:'08/01/2027', ..._KD }),
  baseScheme({ id:'CW-CASTLE-TER', road_name:'Castle Terrace', scheme_extent:'Whole Road', scheme_type:'Carriageway', carriageway_area_m2:1256, budget:43960, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'08/03/2027', date_finish:'12/03/2027', ..._BC }),
  ...
  baseScheme({ id:'CW-CRAIGOWL', road_name:'Craigowl Street', scheme_extent:'Whole Road', scheme_type:'Carriageway', carriageway_area_m2:1486, budget:52010, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'11/01/2027', date_finish:'14/01/2027', ..._BC }),
  baseScheme({ id:'CW-DUNCRAIG', road_name:'Duncraig Road', scheme_extent:'Whole Road', scheme_type:'Carriageway', carriageway_area_m2:516, budget:18060, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'18/01/2027', date_finish:'22/01/2027', ..._KD }),
  baseScheme({ id:'CW-DUNHOLM', road_name:'Dunholm Road', scheme_extent:'Dunholm Street to Duncraig Road', scheme_type:'Carriageway', carriageway_area_m2:1391, budget:48685, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'25/01/2027', date_finish:'29/01/2027', ..._BC }),
  baseScheme({ id:'CW-ELGIN', road_name:'Elgin Street', scheme_extent:'Kingsway Terrace to Nr 6', scheme_type:'Carriageway', carriageway_area_m2:1396, budget:48860, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'16/11/2026', date_finish:'20/11/2026', ..._BC }),
  ...
  baseScheme({ id:'CW-FINELLA', road_name:'Finella Terrace', scheme_extent:'Fintry Road to Nr 24', scheme_type:'Carriageway', carriageway_area_m2:789, budget:27615, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'05/01/2027', date_finish:'09/01/2027', ..._JM }),
  ...
  baseScheme({ id:'R6019-A', road_name:'Langshaw Road', scheme_extent:'Quarry Gardens to Munro Place', scheme_type:'Carriageway', project_number:'R6019', carriageway_area_m2:1780, budget:62300, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'01/06/2026', date_finish:'12/06/2026', ..._BC }),
  baseScheme({ id:'R6020', road_name:'Mid Craigie Road', scheme_extent:'A90 Kingsway to Nr 2', scheme_type:'Carriageway', project_number:'R6020', carriageway_area_m2:3276, budget:121660, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'21/06/2026', date_finish:'02/07/2026', ..._KD }),
  ...
  baseScheme({ id:'R6019-B', road_name:'Napier Drive', scheme_extent:'Quarry Gardens to Langshaw Road', scheme_type:'Carriageway', project_number:'R6019', carriageway_area_m2:1403, budget:49105, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'01/06/2026', date_finish:'12/06/2026', ..._BC }),
  ...
  baseScheme({ id:'CW-RICHMOND', road_name:'Richmond Terrace', scheme_extent:'Windsor Street to Fort Street', scheme_type:'Carriageway', carriageway_area_m2:1376, budget:39550, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'30/11/2026', date_finish:'04/12/2026', ..._BC }),
  ...
  baseScheme({ id:'CW-TORRIDON', road_name:'Torridon Road', scheme_extent:'Fyne Road to Striven Place', scheme_type:'Carriageway', carriageway_area_m2:408, budget:48160, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'23/11/2026', date_finish:'27/11/2026', ..._KD }),
  ...
  baseScheme({ id:'FW-ARBROATH', road_name:'Arbroath Road', scheme_extent:'North Side — Nr 140 to 148', scheme_type:'Footway', footway_area_m2:403, budget:48360, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'29/06/2026', date_finish:'17/07/2026', ..._KD }),
  ...
  baseScheme({ id:'FW-WEDDERBURN', road_name:'Wedderburn Street', scheme_extent:'South Side — Strathmartine Road to Nr 7', scheme_type:'Footway', footway_area_m2:314, budget:23550, financial_year:'2026/27', status:'design', lastUpdated:'today', date_start:'08/06/2026', date_finish:'26/06/2026', ..._BC }),
];
